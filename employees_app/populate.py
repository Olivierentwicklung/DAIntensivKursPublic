...
Employee.objects.create(
    ...
    hire_date=datetime.date(2022, 7, 10),
)
...
Employee.objects.create(
    ...
    salary=4100.00,
    department=sales,
    hire_date=datetime.date(2020, 6, 15),
)
...
Employee.objects.create(
    ...
    salary=5000.00,
    department=engineering,
    hire_date=datetime.date(2019, 1, 20),
)
...
Employee.objects.create(
    ...
    salary=2300.00,
    department=hr,
    hire_date=datetime.date(2023, 1, 5),
)
...
Employee.objects.create(
    ...
    hire_date=datetime.date(2021, 11, 11),
)
...
Employee.objects.create(
    ...
    salary=3100.00,
    department=sales,
    hire_date=datetime.date(2023, 8, 8),
)
